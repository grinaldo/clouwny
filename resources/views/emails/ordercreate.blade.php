                                                            ...
                                                            <div class="column" style="max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                                                ...
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                        <h1 class="size-64" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-64"><span class="font-avenir"><strong><span style="color:#555">Thank You</span></strong></span></h1>
                                                                    </div>
                                                                </div>
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                        <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30"><strong><span style="color:#555">We will process your order soon.</span></strong></p>
                                                                    </div>
                                                                </div>
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
