                ...
                <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody>
                        <tr>
                            <td>
                                <div role="section">
                                    <div style="background-color: #ff7474;">
                                        <div class="layout one-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr class="layout-full-width" style="background-color: #ff7474;">
                                    ...
                                    <div style="background-color: #4b5462;background-position: 0px 0px;background-image: url(http://clouwny.test/images/clouwny-wrap.jpg);background-repeat: repeat;">
                                        <div class="layout one-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                            <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
                                                <!--[if (mso)|(IE)]>
                                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                    <tr class="layout-full-width" style="background-color: #4b5462;background-position: 0px 0px;background-image: url(http://clouwny.test/images/clouwny-wrap.jpg);background-repeat: repeat;">
                                                        <td class="layout__edges">&nbsp;</td>
                                                        <td style="width: 600px" class="w560">
                                                            <![endif]-->
                                                            <div class="column" style="max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                                                ...
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                        <h1 class="size-64" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-64"><span class="font-avenir"><strong><span style="color:#555">Clouwny Order Shipped</span></strong></span></h1>
                                                                    </div>
                                                                </div>
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                        <p class="size-30" style="Margin-top: 0;Margin-bottom: 20px;font-size: 26px;line-height: 34px;text-align: center;" lang="x-size-30"><strong><span style="color:#555">Thanks for Shopping with Us</span></strong></p>
                                                                    </div>
                                                                </div>
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                    ...
                                    <div class="layout one-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
                                                ...
                                                <tr class="layout-fixed-width" style="background-color: #ffffff;">
                                                    <td style="width: 600px" class="w560">
                                                        ...
                                                        <div class="column" style="text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
                                                            ...
                                                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                    <h2 style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: center;"><span style="color:#888"><strong>Here is Your Order Detail</strong></span></h2>
                                                                </div>
                                                            </div>
                                                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                        ...
                                        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff; margin: 20px">
                                            <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="border:1px solid #888; border-collapse: colapse; width: 100%;">
                                                <tr class="layout-fixed-width" style="background-color: #ffffff;">
                                                    <td style="padding:10px; font-size: 14px; font-family: verdana; border: 1px solid #888; color: #555;">
                                                        Order Number
                                                    </td>
                                                    <td style="padding:10px; font-size: 14px; font-family: verdana; border: 1px solid #888; color: #888;">
                                                        #{{ $order->order_number }}
                                                    </td>
                                                </tr>
                                                <tr class="layout-fixed-width" style="background-color: #ffffff;">
                                            ...
                                            <p style="font-size: 14px; font-family: verdana;">
                                                Your shipment is underway. Please wait for our partner to deliver it to you.
                                            </p>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr class="layout-full-width" style="background-color: #ff7474;">
                                                        ...
                                                        <td style="width: 600px" class="w560">
                                                            ...
                                                            <div class="column" style="max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
                                                                ...
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                                                        <h1 class="size-48" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #000;font-size: 36px;line-height: 43px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-48"><span class="font-avenir"><strong><span style="color:#ffffff">Shop More on Clouwny</span></strong></span></h1>
                                                                        <h2 class="size-28" style="Margin-top: 20px;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #e31212;font-size: 24px;line-height: 32px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-28"><font color="#ffffff"><strong>We have the style you need</strong></font></h2>
                                                                    </div>
                                                                </div>
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                ...
                                                                <div style="Margin-left: 20px;Margin-right: 20px;">
                                                                    <div class="btn btn--flat btn--medium" style="Margin-bottom: 20px;text-align: center;">
                                                                        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 12px;font-weight: bold;line-height: 22px;padding: 10px 20px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #e31212 !important;background-color: #ffffff;font-family: sans-serif;" href="http://clouwny.com">Shop Now</a><![endif]>
                                                                        <!--[if mso]>
                                                                        <p style="line-height:0;margin:0;">&nbsp;</p>
                                                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://clouwny.com" style="width:98px" arcsize="10%" fillcolor="#FFFFFF" stroke="f">
                                                                            <v:textbox style="mso-fit-shape-to-text:t" inset="0px,9px,0px,9px">
                                                                                <center style="font-size:12px;line-height:22px;color:#E31212;font-family:sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Shop Now</center>
                                                                            </v:textbox>
                                                                        </v:roundrect>
                                                                        <![endif]-->
                                                                    </div>
